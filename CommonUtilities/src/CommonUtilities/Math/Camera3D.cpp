...
const Quatf& Camera3D::GetRotation() const noexcept			{ return myTransform.GetRotation(); }
...
{
	myProjectionMatrix = Mat4f::CreatePerspective(aHorizontalFOVDeg, aAspectRatio, aNearClip, aFarClip);
...
void Camera3D::SetRotation(const Quatf& aRotation)
{
