...
Keyboard::Key Keyboard::ProcessVirtualKey(WPARAM aVirtualKey, LPARAM someFlags)
{
    switch (aVirtualKey)
    {
        case VK_SHIFT:
        ...
        case VK_CONTROL:    return (HIWORD(someFlags) & KF_EXTENDED) ? Keyboard::RControl : Keyboard::LControl;
...
Keyboard::Key Keyboard::VirtualKeyToCUKey(WPARAM aVirtualKey)
{
    switch (aVirtualKey)
    {
        case 'A':           return Keyboard::A;
